...
public class SchedulingAlgorithm {
  ...
  public static Results Run(int runtime, Vector<sProcess> processVector, Results result) {
    ...
    try {
      ...
      out.println("Process: " + currentProcess + " registered... (" + process.cputime + " " + process.ioblocking + " " + process.cpudone + " " + process.cpudone + " " + process.tickets +")");
      while (comptime < runtime) {
        if (process.cpudone == process.cputime) {
          completed++;
          out.println("Process: " + currentProcess + " completed... (" + process.cputime + " " + process.ioblocking + " " + process.cpudone + " " + process.cpudone + " " + process.tickets +")");
          if (completed == size) {
        ...
        if (process.ioblocking == process.ionext) {
          out.println("Process: " + currentProcess + " I/O blocked... (" + process.cputime + " " + process.ioblocking + " " + process.cpudone + " " + process.cpudone + " " + process.tickets + ")");
          process.numblocked++;
          process.ionext = 0;
          //here comes my lottery algorithm
          while(true) {
